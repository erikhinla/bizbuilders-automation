...
import { VideoBackground, AnimatedGradientBackground } from './components/VideoBackground'
...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    if (email) {
      ...
      // You can add API call here to send email to your backend
    }
  }
  ...
  const handleScheduleCall = () => {
    // You can replace this with your actual Calendly or scheduling link
    const calendlyUrl = 'https://calendly.com/your-username/consultation' // Replace with your actual Calendly URL
    window.open(calendlyUrl, '_blank')
    // Alternative: You can show a modal or form here instead
  }

  const handleLogin = () => {
    // You can replace this with your actual login page route or modal
    // For now, we'll navigate to /hub if it exists, or show an alert
    if (window.location.pathname === '/') {
      window.location.href = '/hub'
    } else {
      // Show login modal or redirect to login page
      alert('Login functionality - You can connect this to your authentication system')
    }
  }
  ...
  return (
    <HelmetProvider>
      ...
      {/* Animated particles for extra aliveness */}
      <AnimatedParticles count={50} className="z-0" />
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            >
              {!isSubmitted ? (
                <form id="email-form" onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                  <Input
                    id="email-input"
                    type="email"
